export default function ReviewBox(){
    return (
        <div className="w-[400px] py-7 px-8 flex flex-col gap-4 border border-[#0000001A] rounded-[20px]">
           ...
           <div className="flex items-center gap-1">
             <h4 className="text-xl font-bold text-black leading-[22px]">James L.</h4>
             <div>
           ...
           <p className="leading-[22px] text-[#00000099]">"As someone who's always on the lookout for unique fashion pieces, I'm thrilled to have stumbled upon Shop.co. The selection of clothes is not only diverse but also on-point with the latest trends.”</p>
        </div>
    )
}