...
import { useGetNewArrivalsQuery } from "@/redux/api/productApi"; // RTK Query hook
...
export default function NewArrival() {
  ...
  // RTK Query call
  const { data, isLoading } = useGetNewArrivalsQuery({ page: currentPage, limit });
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="product_section">
          <div className="flex justify-between">
            <h2 className="text-[32px] font-bold text-black">New Arrivals</h2>
          </div>
